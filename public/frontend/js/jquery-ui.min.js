                    ...
                    parse: function(e, s, n, r) {
                        if (void 0 === e)
                            return this._rgba = [null, null, null, null],
                                this;
                        (e.jquery || e.nodeType) && (e = t(e).css(s),
                            s = void 0);
                        var h = this
                            , l = t.type(e)
                            , p = this._rgba = [];
                        return void 0 !== s && (e = [e, s, n, r],
                            l = "array"),
            ...
            !1 !== t.uiBackCompat && t.extend(t.effects, {
                ...
                restore: function(t, e) {
                    for (var i, s = 0, n = e.length; s < n; s++)
                        null !== e[s] && (i = t.data("ui-effects-" + e[s]),
                            t.css(e[s], i))
                },
                ...
                t.fn.extend({
                    effect: function() {
                        ...
                        if (t.fx.off || !s)
                            return l ? this[l](e.duration, h) : this.each(function() {
                                h && h.call(this)
                            });
                        function d(i) {
                            var o = t(this);
                            function r() {
                                t.isFunction(h) && h.call(o[0]),
                                t.isFunction(i) && i()
                            }
                            e.mode = c.shift(),
                                !1 === t.uiBackCompat || n ? "none" === e.mode ? (o[l](),
                                    r()) : s.call(o[0], e, function() {
                                    o.removeData(a),
                                        t.effects.cleanUp(o),
                                    "hide" === e.mode && o.hide(),
                                        r()
    ...
    t.extend(t.ui, {
        ...
        t.extend(d.prototype, {
            ...
            _showDatepicker: function(e) {
                ...
                !1 !== (n = (s = t.datepicker._get(i, "beforeShow")) ? s.apply(e, [e, i]) : {}) && (g(i.settings, n),
                    i.lastVal = null,
    ...
    t.ui.ddmanager = {
        ...
        drop: function(e, i) {
            ...
            return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && _(e, this, this.options.tolerance, i) && (s = this._drop.call(this, i) || s),
