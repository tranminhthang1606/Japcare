            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <h4 class="mt-0 header-title border_b">
                        Dánh sách thành phần
                        <a href="{{ url('/admin/ingredients/create') }}" class="btn btn-info waves-effect pull-right">Thêm thành phần</a>
                    </h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group pull-right">
                                        <a href="{{ route('ingredients.index') }}" class="btn btn-blue-grey mr-2">
                                            Hủy lọc
                                        </a>
                                    ...
                                    @foreach($ingredients as $key => $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('/admin/ingredients/' . $item->id ) . '/edit'}}">
                                                    <span class="badge badge-brown"><i class="fa fa-pencil"></i></span>
                                                </a>
                                                <a onclick="confirm_modal('{{route('ingredients.destroy', $item->id)}}');">
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12 col-md-5">
                            <div class="dataTables_info">
                                Tổng {{$ingredients->total()}} thành phần
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-7">
                            <div class="pull-right">
                                @if(count($ingredients) > 0)
                                    {{ $ingredients->appends(request()->query())->render('admins.inc.pagination') }}
                                @endif
                            </div>
                        </div>
                    </div>
