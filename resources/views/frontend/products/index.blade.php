...
@section('title', request('keyword') ? "Tìm kiếm sản phẩm" : (isset($category) ? $category->title: 'Danh sách sản
phẩm'))
@section('description', request('keyword') ? "Tìm kiếm sản phẩm" : (isset($category) ? $category->meta_description:
'Danh sách sản phẩm'))
@section('keywords', request('keyword') ? "Tìm kiếm sản phẩm" : (isset($category) ? $category->title: 'Danh sách sản
phẩm'))
@section('meta_keywords', request('keyword') ? "Tìm kiếm sản phẩm" : (isset($category) ? $category->meta_title: 'Danh
sách sản phẩm'))
@section('meta_description', request('keyword') ? "Tìm kiếm sản phẩm" : (isset($category) ? $category->meta_description:
'Danh sách sản phẩm'))
@section('content')
<div class="container">
    <nav>
...
<div class="container product_main-content">
    <div class="row">
        <div class="col-lg-3">
                        ...
                        <div class="new_product-card">
                            <div class="wrap">
                                <a href="{{route('product-detail',$item->slug)}}"><img
                                        src="{{ asset($item->featured_img) }}" alt=""></a>
                                <div class="new_product-content w-100 p-2">
                                    ...
                                    <div class="product_price">
                                        ...
                                        <del class="old-price">{{$item->price}}đ</del>
